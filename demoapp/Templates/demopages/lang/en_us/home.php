...
return $page = [
    ...
    'intro_para_prod' => 'Core Framework is PHP framework that helps developing and maintaining web applications easier. Core PHP Frameworks comes with common features and functions build into it, thus eliminating the need to rewrite code, and enabling you, the developer, to focus on what matters, the core logic behind your web app.',
