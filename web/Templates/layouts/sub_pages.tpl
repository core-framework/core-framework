<section id="overview" class="container">
    ...
    <h3 class="subTitle">
        <{if isset($documentation.subTitle1) }>
            ...
            <a class="permalink" href="#<{$documentation.subTitle1_pLink}>">&para;</a>
        <{/if}>
    </h3>
    <div class="block">
    ...
    <h3 class="subTitle">
        <{if isset($documentation.subTitle2) }>
            ...
            <a class="permalink" href="#<{$documentation.subTitle2_pLink}>">&para;</a>
        <{/if}>
    </h3>
    <div class="block">
    ...
    <h3 class="subTitle">
        <{if isset($documentation.subTitle3) }>
            ...
            <a class="permalink" href="#<{$documentation.subTitle3_pLink}>">&para;</a>
        <{/if}>
    </h3>
    <div class="block">
